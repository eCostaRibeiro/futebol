 ...
 * @author Stwuart
 */
public class CadastroCampeonato extends javax.swing.JInternalFrame {
     ...
     * @param jDPPrincipal
     */
    public CadastroCampeonato(JDesktopPane jDPPrincipal) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //leitura dos campos
        Integer codCamp = Integer.parseInt(jcodCamp.getText());
        String nomeCamp = jnomeCamp.getText();
        String anoCamp = janoCamp.getText();

        // Criando objeto do Campeonato
        ...
        try{
            ...
            if (controle.cadastrarCampeonato(camp)){
                camp.setCodCamp(codCamp);
                camp.setNomeCamp(nomeCamp);
                camp.setAnoCamp(anoCamp);
                
                CampeonatoDAO campeonatoDAO = new CampeonatoDAO(camp);
